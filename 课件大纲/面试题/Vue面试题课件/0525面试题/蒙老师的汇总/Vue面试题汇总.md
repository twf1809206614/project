...
编译模板就是通过一个compile方法把模板编译成AST虚拟语法树，最终转换为一个render函数，通过该render函数可以生成虚拟节点。（AST的关键）
...
相关插件：[vue-virtual-scroller](https://github.com/Akryum/vue-virtual-scroller)，clusterize.js
